...
const Header = () => {
  ...
  // ✅ ВИПРАВЛЕНО: 'i18n' змінено на '_i18n', щоб уникнути помилки no-unused-vars (Рядок 17)
  ...
  // Хелпер для обробки клавіатури на бекдропі
  ...
  return (
    <div className={css['header-wrapper']}>
      <nav className={css['header-container']}>
        ...
        {/* ✅ ВИПРАВЛЕНО A11y: Додано role, tabIndex та onKeyDown (Рядок 97) */}
        <div
          className={`${css['menu-backdrop']} ${isMenuOpen ? css['is-visible'] : ''}`}
          onClick={toggleMenu}
          role="button"
